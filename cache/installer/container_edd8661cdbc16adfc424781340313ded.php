...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000005c996fc7000000006ab83e78(
...
class phpbbtemplatetwiglexer_000000005c996fc7000000006ab83e78 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5de043fc845f1869787031 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5de043fc845f5715044497 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5de043fc845de239890467 = array(
    ...
    {
        $this->initializer5de043fc845f5715044497 && ($this->initializer5de043fc845f5715044497->__invoke($valueHolder5de043fc845f1869787031, $this, 'set_environment', array('env' => $env), $this->initializer5de043fc845f5715044497) || 1) && $this->valueHolder5de043fc845f1869787031 = $valueHolder5de043fc845f1869787031;

        return $this->valueHolder5de043fc845f1869787031->set_environment($env);
    }
    ...
    {
        $this->initializer5de043fc845f5715044497 && ($this->initializer5de043fc845f5715044497->__invoke($valueHolder5de043fc845f1869787031, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5de043fc845f5715044497) || 1) && $this->valueHolder5de043fc845f1869787031 = $valueHolder5de043fc845f1869787031;

        return $this->valueHolder5de043fc845f1869787031->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5de043fc845f5715044497 && ($this->initializer5de043fc845f5715044497->__invoke($valueHolder5de043fc845f1869787031, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5de043fc845f5715044497) || 1) && $this->valueHolder5de043fc845f1869787031 = $valueHolder5de043fc845f1869787031;

        return $this->valueHolder5de043fc845f1869787031->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5de043fc845f5715044497 = $initializer;
    }
    ...
    {
        $this->initializer5de043fc845f5715044497 && ($this->initializer5de043fc845f5715044497->__invoke($valueHolder5de043fc845f1869787031, $this, '__get', array('name' => $name), $this->initializer5de043fc845f5715044497) || 1) && $this->valueHolder5de043fc845f1869787031 = $valueHolder5de043fc845f1869787031;

        if (isset(self::$publicProperties5de043fc845de239890467[$name])) {
            return $this->valueHolder5de043fc845f1869787031->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5de043fc845f1869787031;
    ...
    {
        $this->initializer5de043fc845f5715044497 && ($this->initializer5de043fc845f5715044497->__invoke($valueHolder5de043fc845f1869787031, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5de043fc845f5715044497) || 1) && $this->valueHolder5de043fc845f1869787031 = $valueHolder5de043fc845f1869787031;
    ...
    {
        $this->initializer5de043fc845f5715044497 && ($this->initializer5de043fc845f5715044497->__invoke($valueHolder5de043fc845f1869787031, $this, '__isset', array('name' => $name), $this->initializer5de043fc845f5715044497) || 1) && $this->valueHolder5de043fc845f1869787031 = $valueHolder5de043fc845f1869787031;
    ...
    {
        $this->initializer5de043fc845f5715044497 && ($this->initializer5de043fc845f5715044497->__invoke($valueHolder5de043fc845f1869787031, $this, '__unset', array('name' => $name), $this->initializer5de043fc845f5715044497) || 1) && $this->valueHolder5de043fc845f1869787031 = $valueHolder5de043fc845f1869787031;
    ...
    {
        $this->initializer5de043fc845f5715044497 && ($this->initializer5de043fc845f5715044497->__invoke($valueHolder5de043fc845f1869787031, $this, '__clone', array(), $this->initializer5de043fc845f5715044497) || 1) && $this->valueHolder5de043fc845f1869787031 = $valueHolder5de043fc845f1869787031;

        $this->valueHolder5de043fc845f1869787031 = clone $this->valueHolder5de043fc845f1869787031;
    }

    public function __sleep()
    {
        $this->initializer5de043fc845f5715044497 && ($this->initializer5de043fc845f5715044497->__invoke($valueHolder5de043fc845f1869787031, $this, '__sleep', array(), $this->initializer5de043fc845f5715044497) || 1) && $this->valueHolder5de043fc845f1869787031 = $valueHolder5de043fc845f1869787031;

        return array('valueHolder5de043fc845f1869787031');
    }
    ...
    {
        return $this->initializer5de043fc845f5715044497;
    }
    ...
    {
        return $this->initializer5de043fc845f5715044497 && ($this->initializer5de043fc845f5715044497->__invoke($valueHolder5de043fc845f1869787031, $this, 'initializeProxy', array(), $this->initializer5de043fc845f5715044497) || 1) && $this->valueHolder5de043fc845f1869787031 = $valueHolder5de043fc845f1869787031;
    }
    ...
    {
        return null !== $this->valueHolder5de043fc845f1869787031;
    }
    ...
    {
        return $this->valueHolder5de043fc845f1869787031;
    }
