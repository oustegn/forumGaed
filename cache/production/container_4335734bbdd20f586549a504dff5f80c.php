...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000006aa88be0000000000e9e948(
...
class phpbbtemplatetwiglexer_0000000006aa88be0000000000e9e948 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5de0442527bff047850930 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5de0442527c04395878387 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5de0442527bee215736592 = array(
    ...
    {
        $this->initializer5de0442527c04395878387 && ($this->initializer5de0442527c04395878387->__invoke($valueHolder5de0442527bff047850930, $this, 'set_environment', array('env' => $env), $this->initializer5de0442527c04395878387) || 1) && $this->valueHolder5de0442527bff047850930 = $valueHolder5de0442527bff047850930;

        return $this->valueHolder5de0442527bff047850930->set_environment($env);
    }
    ...
    {
        $this->initializer5de0442527c04395878387 && ($this->initializer5de0442527c04395878387->__invoke($valueHolder5de0442527bff047850930, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5de0442527c04395878387) || 1) && $this->valueHolder5de0442527bff047850930 = $valueHolder5de0442527bff047850930;

        return $this->valueHolder5de0442527bff047850930->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5de0442527c04395878387 && ($this->initializer5de0442527c04395878387->__invoke($valueHolder5de0442527bff047850930, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5de0442527c04395878387) || 1) && $this->valueHolder5de0442527bff047850930 = $valueHolder5de0442527bff047850930;

        return $this->valueHolder5de0442527bff047850930->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5de0442527c04395878387 = $initializer;
    }
    ...
    {
        $this->initializer5de0442527c04395878387 && ($this->initializer5de0442527c04395878387->__invoke($valueHolder5de0442527bff047850930, $this, '__get', array('name' => $name), $this->initializer5de0442527c04395878387) || 1) && $this->valueHolder5de0442527bff047850930 = $valueHolder5de0442527bff047850930;

        if (isset(self::$publicProperties5de0442527bee215736592[$name])) {
            return $this->valueHolder5de0442527bff047850930->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5de0442527bff047850930;
    ...
    {
        $this->initializer5de0442527c04395878387 && ($this->initializer5de0442527c04395878387->__invoke($valueHolder5de0442527bff047850930, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5de0442527c04395878387) || 1) && $this->valueHolder5de0442527bff047850930 = $valueHolder5de0442527bff047850930;
    ...
    {
        $this->initializer5de0442527c04395878387 && ($this->initializer5de0442527c04395878387->__invoke($valueHolder5de0442527bff047850930, $this, '__isset', array('name' => $name), $this->initializer5de0442527c04395878387) || 1) && $this->valueHolder5de0442527bff047850930 = $valueHolder5de0442527bff047850930;
    ...
    {
        $this->initializer5de0442527c04395878387 && ($this->initializer5de0442527c04395878387->__invoke($valueHolder5de0442527bff047850930, $this, '__unset', array('name' => $name), $this->initializer5de0442527c04395878387) || 1) && $this->valueHolder5de0442527bff047850930 = $valueHolder5de0442527bff047850930;
    ...
    {
        $this->initializer5de0442527c04395878387 && ($this->initializer5de0442527c04395878387->__invoke($valueHolder5de0442527bff047850930, $this, '__clone', array(), $this->initializer5de0442527c04395878387) || 1) && $this->valueHolder5de0442527bff047850930 = $valueHolder5de0442527bff047850930;

        $this->valueHolder5de0442527bff047850930 = clone $this->valueHolder5de0442527bff047850930;
    }

    public function __sleep()
    {
        $this->initializer5de0442527c04395878387 && ($this->initializer5de0442527c04395878387->__invoke($valueHolder5de0442527bff047850930, $this, '__sleep', array(), $this->initializer5de0442527c04395878387) || 1) && $this->valueHolder5de0442527bff047850930 = $valueHolder5de0442527bff047850930;

        return array('valueHolder5de0442527bff047850930');
    }
    ...
    {
        return $this->initializer5de0442527c04395878387;
    }
    ...
    {
        return $this->initializer5de0442527c04395878387 && ($this->initializer5de0442527c04395878387->__invoke($valueHolder5de0442527bff047850930, $this, 'initializeProxy', array(), $this->initializer5de0442527c04395878387) || 1) && $this->valueHolder5de0442527bff047850930 = $valueHolder5de0442527bff047850930;
    }
    ...
    {
        return null !== $this->valueHolder5de0442527bff047850930;
    }
    ...
    {
        return $this->valueHolder5de0442527bff047850930;
    }
