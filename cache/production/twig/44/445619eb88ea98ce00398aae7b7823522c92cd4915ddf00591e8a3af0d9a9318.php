...
class __TwigTemplate_0b48e4b074e721bc06a1e5aba6eee4874476e12a376dd0f7cf61e614aa1b87b2 extends \Twig\Template
{
...
\t";
        ...
        // line 12
        echo "\t";
        if (twig_length_filter($this->env, $this->getAttribute(($context["loops"] ?? null), "leader", []))) {
            // line 13
...
\t";
        // line 44
        if (twig_length_filter($this->env, $this->getAttribute(($context["loops"] ?? null), "member", []))) {
            // line 45
            echo "\t\t<ul class=\"topiclist two-columns\">
\t\t\t<li class=\"header\">
\t\t\t\t<dl>
...
";
        // line 78
        if (twig_length_filter($this->env, $this->getAttribute(($context["loops"] ?? null), "pending", []))) {
            // line 79
...
\t\t";
            // line 91
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["loops"] ?? null), "pending", []));
...
";
        ...
        // line 112
        if (twig_length_filter($this->env, $this->getAttribute(($context["loops"] ?? null), "nonmember", []))) {
            // line 113
            echo "<div class=\"panel\">
\t<div class=\"inner\">
\t\t<ul class=\"topiclist two-columns\">
...
\t\t";
            // line 125
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["loops"] ?? null), "nonmember", []));
...
\t";
        // line 148
        if ((($context["S_CHANGE_DEFAULT"] ?? null) || ($this->getAttribute(($context["definition"] ?? null), "SHOW_BUTTONS", []) == 1))) {
            // line 149
            echo "\t<fieldset>
\t\t";
            // line 150
...
\t\t";
            // line 157
            if (($this->getAttribute(($context["definition"] ?? null), "SHOW_BUTTONS", []) == 1)) {
                // line 158
